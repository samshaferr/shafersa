...
setwd("C:/GitHub/shafersa/Week11")
...
image_darknet_detect(file = "C:/GitHub/shafersa/Week11/BearSalmon2.jpg",
                     object = yolo_tiny_voc)

image_darknet_detect(file = "C:/GitHub/shafersa/Week11/BearSalmon.jpg",
                     object = yolo_tiny_voc,
                     threshold = .05)

image_darknet_detect(file = "C:/GitHub/shafersa/Week11/Bird.jpg",
                     object = yolo_tiny_voc)

image_darknet_detect(file = "C:/GitHub/shafersa/Week11/Urban.jpg",
                     object = yolo_tiny_voc)
...
image_darknet_classify(file = "C:/GitHub/shafersa/Week11/BearSalmon.jpg",
                       object = tiny_model)
