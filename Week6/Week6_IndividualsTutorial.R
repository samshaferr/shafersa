...
#Gaussian means its a normal distribution
#1 | ID= random effect
...
#two outputs, one is marginal, one is conditional, we care about the marginal R^2
#This R^2 function is specific to this package
...
plot(glmm.mod2)
##Residuals refer to the distance above and below the best fit line, homogeneity= uniform
...
## random = list(ID=~ 1), this is where it is common to run into errors. Getting the syntax right
summary(gam.mod1)
...
## * = that variables can interact with each other
summary(gam.mod2)
